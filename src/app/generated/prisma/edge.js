...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/aisheibrahim/code/github/todo-app/todo-backend/src/app/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/aisheibrahim/code/github/todo-app/todo-backend/src/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../../.env",
  ...
  "inlineSchema": "// datasource db { provider = \"mysql\", url = env(\"DATABASE_URL\") }\n// generator client { provider = \"prisma-client-js\" }\n// model Task {\n//   id Int @id @default(autoincrement())\n//   title String\n//   description String?\n//   completed Boolean @default(false)\n//   dueDate DateTime?\n//   createdAt DateTime @default(now())\n//   updatedAt DateTime @updatedAt\n// }\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../app/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id    Int     @id @default(autoincrement())\n  email String  @unique\n  name  String?\n  posts Post[]\n}\n\nmodel Post {\n  id        Int     @id @default(autoincrement())\n  title     String\n  content   String?\n  published Boolean @default(false)\n  authorId  Int\n  author    User    @relation(fields: [authorId], references: [id])\n}\n",
  "inlineSchemaHash": "2da7e156e2482c8b81b2f8cbffe0f4eebf3127605e23e3633931c8c9f7c6484e",
  "copyEngine": true
}
config.dirname = '/'
